  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        <linearGradient id="pathGradientDark" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#14b8a6" />
          <stop offset="50%" stopColor="#06b6d4" />
          <stop offset="100%" stopColor="#8b5cf6" />
        </linearGradient>
        {/* Light mode gradient - brighter, more visible */}
        <linearGradient id="pathGradientLight" x1="0%" y1="0%" x2="100%" y2="100%">
...
/**
 * Animated flowing paths background component
 * Use this on any page to add the animated teal/cyan/violet paths
 * 
 * @example
 ...
 * </div>
 */
export function AnimatedPaths({ isDark = true }: AnimatedPathsProps) {
  return (
